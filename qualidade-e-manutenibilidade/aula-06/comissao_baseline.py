"""
Cálculo de comissão — referência congelada para equivalência funcional.

Não altere este arquivo durante a refatoração; use-o como fonte da verdade do comportamento.
"""
