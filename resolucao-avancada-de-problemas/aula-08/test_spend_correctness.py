...
def test_summarize_customer_spend_keeps_customer_order() -> None:
    customers = [
        {"customer_id": 42, "name": "Z"},
        {"customer_id": 7, "name": "A"},
    ]
    summary, _ = summarize_customer_spend(customers, [])

    assert [row["customer_id"] for row in summary] == [42, 7]
