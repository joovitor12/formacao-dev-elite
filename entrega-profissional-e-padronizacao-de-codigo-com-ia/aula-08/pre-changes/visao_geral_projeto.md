...
## 10. Próximo passo (revisão final)

1. Criar `tests/` com pytest (`prompts.md` §1).
2. Completar `verificar_pipeline.py` e `ci/qualidade-mvp.yml` (`prompts.md` §2).
3. Containerizar com `Dockerfile` (`prompts.md` §3).
4. Checklist completo em `proximos_passos.md` — PR com CI verde.
