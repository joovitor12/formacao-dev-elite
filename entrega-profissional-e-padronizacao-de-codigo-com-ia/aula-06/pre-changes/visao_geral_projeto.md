...
## 10. Próximo passo (arquitetura e decisões)

1. Preencher ADRs em `decisoes_arquitetura.md`.
2. Criar pacote `server/` e deps **via IA** (prompts da entrega de arquitetura).
3. Validar com `verificar_arquitetura.py`.
4. Implementação completa do agente no sandbox — entrega seguinte.
