...
## 10. Próximo passo (implementação)

Com a visão alinhada, a sequência típica é:

1. Instalar `parlant` e subir servidor mínimo.
2. Configurar `NLPServices.openrouter` com `openrouter/owl-alpha`.
3. Criar agente + guidelines de onboarding.
4. Validar no sandbox; iterar com IA citando `padrao_projeto_mvp.md`.
