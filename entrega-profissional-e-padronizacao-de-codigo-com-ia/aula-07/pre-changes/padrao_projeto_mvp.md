...
- **Parlant (oficial):** https://parlant.io/docs — use para validar SDK, guidelines, tools e integração com providers antes de aceitar código da IA.
- Instalação e quickstart: https://parlant.io/docs/quickstart/installation
...
2. Declarar: *“Siga estritamente padrao_projeto_mvp.md; consulte https://parlant.io/docs para APIs do Parlant; não invente outro layout ou provider.”*
