...
from app.config import (
    get_http_cat_base_url,
    get_http_cat_default_source,
    get_http_cat_fallback_source,
    get_http_cat_fallback_status_code,
    get_http_cat_image_extension,
    get_http_cat_timeout_seconds,
)
...
class HttpCatService:
    async def fetch_cat_by_status(self, status_code: int) -> HttpCatAssetData:
        ...
        request_timeout_seconds: float = get_http_cat_timeout_seconds()
        default_source: str = get_http_cat_default_source()
    ...
    def _build_image_url(self, status_code: int) -> str:
        http_cat_base_url: str = get_http_cat_base_url()
        image_extension: str = get_http_cat_image_extension()
    ...
    def _build_fallback_response(
        ...
        fallback_status_code: int = get_http_cat_fallback_status_code()
        fallback_source: str = get_http_cat_fallback_source()
