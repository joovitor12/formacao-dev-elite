"""Verifica checklist do dossiê integrador."""
...
DOSSIE = Path(__file__).resolve().parent / "dossie_container_integrado.md"
...
def main() -> int:
    ...
    if pendentes:
        print("Marque todos os itens em dossie_container_integrado.md")
        return 1
    return 0
